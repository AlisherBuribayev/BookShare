            ...
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2><i class="fa fa-flag-o red"></i><strong> Subscriptions</strong></h2>
                        ...
                        <table class="table bootstrap-datatable countries">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$subscription->money}}</td>
                                    <td>{{$subscription->term}}</td>
                                    <td><a href="{{route('subscription', $subscription->id)}}"><i
                                                class="fa fa-eye text-success"></i></a></td>
                                    <td><a href="{{route('subscription.edit', $subscription->id)}}"><i
                                                class="fa fa-edit text-info"></i></a></td>
                                    <td><a href="{{route('subscription.destroy', $subscription->id)}}"
                                            class="text-danger"><i class="fa fa-trash"></i>Delete</a></td>
